            ...
            <div className="max_padd_container py-10 flex flex-row items-center justify-between">
                <div className='flex flex-row items-center justify-between gap-3 p-1'>
                    <div className='flex flex-row gap-3 items-center justify-around'>
                        ...
                        <h1 className='text-xl font-bold whitespace-nowrap'>Dog<span className='text-green-100 font-bold'>Industry.</span></h1>
                    </div>
                </div>
                {/*mobile Menu*/}
                ...
                {menuOpen ? (
                    <nav className="md:hidden flex items-center flex-col gap-y-12 fixed top-28 right-3 p-8 bg-white rounded-3xl shadow-md w-48 medium-16 ring-1 ring-slate-900/5 transition-all duration-300">
                        <NavLink to={'/'} onClick={closeMenu} className={({ isActive }) => isActive ? "active-link" : ""} ><div className='font-bold text-lg'>Home</div></NavLink>
                        <NavLink to={'/gallery'} onClick={closeMenu} className={({ isActive }) => isActive ? "active-link" : ""} ><div className='font-bold text-lg'>Gallery</div></NavLink>
                        <NavLink to={'/breed'} onClick={closeMenu} className={({ isActive }) => isActive ? "active-link" : ""} ><div className='font-bold text-lg'>Breed</div></NavLink>
                    </nav>
                ) : ""}
                ...
                <nav className='hidden md:flex flex-row items-center px-10 gap-16 font-bold rounded-3xl'>
                    <NavLink to={'/'} className={({ isActive }) => isActive ? "active-link" : ""} ><div className='font-bold text-lg'>Home</div></NavLink>
                    <NavLink to={'/gallery'} className={({ isActive }) => isActive ? "active-link" : ""} ><div className='font-bold text-lg'>Gallery</div></NavLink>
                    <NavLink to={'/breed'} className={({ isActive }) => isActive ? "active-link" : ""} ><div className='font-bold text-lg'>Breed</div></NavLink>
                </nav>
            </div>
        </header>
    );
